...
if($_POST){
    try {
        ...
        $query = "UPDATE trens SET linha=:linha, numero_trem=:numero_trem, modelo=:modelo, capacidade=:capacidade, status_trem=:status_trem, data_ultima_manutencao=:data_ultima_manutencao WHERE id_trem=:id_trem";
        ...
        if($stmt->execute()){
            $_SESSION['message'] = "Trem atualizado com sucesso!";
            $_SESSION['message_type'] = "success";
        } else {
            $_SESSION['message'] = "Erro ao atualizar trem.";
        ...
        if($exception->getCode() == 23000) {
            ...
            $_SESSION['message'] = "Erro ao atualizar trem: " . $exception->getMessage();
            $_SESSION['message_type'] = "error";
        }
    }
